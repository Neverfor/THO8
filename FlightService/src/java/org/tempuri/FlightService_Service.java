 ...
 * 
 */
@WebServiceClient(name = "FlightService", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/C:/Users/Michael/Documents/GitHub/THO8/FlightService/src/conf/xml-resources/web-services/FlightService/wsdl/FlightService.svc.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Users/Michael/Documents/GitHub/THO8/FlightService/src/conf/xml-resources/web-services/FlightService/wsdl/FlightService.svc.wsdl");
    ...
    public FlightService getBasicHttpBindingFlightService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_FlightService"), FlightService.class);
    }
    ...
    public FlightService getBasicHttpBindingFlightService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_FlightService"), FlightService.class, features);
    }
