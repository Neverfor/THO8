...
@XmlSeeAlso({
    ...
    nl.themaopdracht8.flightservice.ObjectFactory.class,
    org.datacontract.schemas._2004._07.flightservice.ObjectFactory.class,
...
public interface FlightService {
     ...
     * @param flightId
     * @return
     *     returns org.datacontract.schemas._2004._07.flightservice.FlightDTO
     * @throws FlightServiceGetFlightByIdExceptionFaultFaultMessage
     */
    @WebMethod(operationName = "GetFlightById", action = "http://flightservice.themaopdracht8.nl/FlightService/GetFlightById")
    @WebResult(name = "GetFlightByIdResult", targetNamespace = "http://flightservice.themaopdracht8.nl")
    @RequestWrapper(localName = "GetFlightById", targetNamespace = "http://flightservice.themaopdracht8.nl", className = "nl.themaopdracht8.flightservice.GetFlightById")
    @ResponseWrapper(localName = "GetFlightByIdResponse", targetNamespace = "http://flightservice.themaopdracht8.nl", className = "nl.themaopdracht8.flightservice.GetFlightByIdResponse")
