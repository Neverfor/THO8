...
public class ObjectFactory {
    ...
    private final static QName _GetPersonalBookingsUserToken_QNAME = new QName("http://flightservice.themaopdracht8.nl", "userToken");
    ...
    public JAXBElement<String> createGetPersonalBookingsUserToken(String value) {
        return new JAXBElement<String>(_GetPersonalBookingsUserToken_QNAME, String.class, GetPersonalBookings.class, value);
    }
    ...
    public JAXBElement<String> createBookFlightUserToken(String value) {
        return new JAXBElement<String>(_GetPersonalBookingsUserToken_QNAME, String.class, BookFlight.class, value);
    }
